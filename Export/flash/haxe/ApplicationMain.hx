...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Fall", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("Fall", null, 1200, 800);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Fall";
		app.meta["name"] = "Knight";
		app.meta["packageName"] = "com.sample.tossup";
	...
	macro public static function getPreloader()
	{
		...
		var type = Context.getType("org.flashbacks1998.rake.Preloader");
			...
			case TInst(classType, _):
				...
				while (searchTypes != null)
				{
					if (searchTypes.pack.length == 2 && searchTypes.pack[0] == "openfl" && searchTypes.pack[1] == "display" && searchTypes.name == "Preloader")
					{
						return macro
						{
							new org.flashbacks1998.rake.Preloader();
						};
					}
		...
		return macro
		{
			new openfl.display.Preloader(new org.flashbacks1998.rake.Preloader());
		}
